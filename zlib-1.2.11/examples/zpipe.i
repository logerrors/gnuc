...
int def(FILE *source, FILE *dest, int level)
{
    ...
    strm.zfree = 0;
    strm.opaque = 0;
    ret = deflateInit_((&strm), (level), "1.2.11", (int)sizeof(z_stream));
    if (ret != 0)
        return ret;
    ...
    do {
        ...
        do {
            ...
            ((ret != (-2)) ? (void) (0) : __assert_fail ("ret != (-2)", "zpipe.c", 68, __PRETTY_FUNCTION__));
        ...
        ((strm.avail_in == 0) ? (void) (0) : __assert_fail ("strm.avail_in == 0", "zpipe.c", 75, __PRETTY_FUNCTION__));


    } while (flush != 4);
    ((ret == 1) ? (void) (0) : __assert_fail ("ret == 1", "zpipe.c", 79, __PRETTY_FUNCTION__));
...
int inf(FILE *source, FILE *dest)
{
    ...
    strm.avail_in = 0;
    strm.next_in = 0;
    ret = inflateInit_((&strm), "1.2.11", (int)sizeof(z_stream));
    if (ret != 0)
        return ret;
    ...
    do {
        ...
        do {
            ...
            strm.next_out = out;
            ret = inflate(&strm, 0);
            ((ret != (-2)) ? (void) (0) : __assert_fail ("ret != (-2)", "zpipe.c", 126, __PRETTY_FUNCTION__));
            switch (ret) {
            case 2:
                ret = (-3);
            case (-3):
